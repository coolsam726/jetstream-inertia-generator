...
```shell
npm install --include=dev --legacy-peer-deps @headlessui/vue @vitejs/plugin-vue pagetables popper.js @babel/plugin-syntax-dynamic-import dayjs dotenv numeral postcss postcss-import pusher-js laravel-echo laravel-vite sass sass-loader vite vue@^3.1 vue3-vt-notifications vue-flatpickr-component  vue-numerals vue-pdf mitt savannabits/vue-select#v4.0.0-alpha.0
```
Or if you are using yarn:
```shell
yarn add -D @headlessui/vue @vitejs/plugin-vue pagetables popper.js @babel/plugin-syntax-dynamic-import dayjs dotenv numeral postcss postcss-import pusher-js laravel-echo laravel-vite sass sass-loader vite vue@^3.1 vue3-vt-notifications vue-flatpickr-component  vue-numerals vue-pdf mitt savannabits/vue-select#v4.0.0-alpha.0
```
