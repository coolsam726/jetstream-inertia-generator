    ...
    <div>
        ...
        <slot>
            <jig-select v-if="type==='select'"
                       ...
                       :required="isRequired"
            />
            <jig-textarea v-else-if="type==='textarea'"
                       v-bind="attribs"
                       :id="id"
                       :model-value="modelValue"
                       @update:modelValue="$emit('update:modelValue', $event)"
                       ...
                       :required="isRequired"
            />
            <jet-checkbox v-else-if="type==='checkbox'"
                       v-bind="attribs"
                       :id="id"
                       v-model="modelValue"
                       :checked="modelValue"
                       ...
                       :required="isRequired"
            />
            <infinite-select v-else-if="type==='infinite-select'"
                       v-bind="attribs"
                       :id="id"
                        :model-value="modelValue"
...
export default {
    ...
    computed: {
        isRequired() {
            return this.required!==undefined && this.required !==false && this.required !=='false'
        },
        attribs() {
            return {
